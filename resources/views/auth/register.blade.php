  ...
  <div class="auth-container">
    <div class="auth-card">
      ...
      <div class="auth-logo">
        ...
        <h1>{{ __('common.general.create_account') }}</h1>
        <p>{{ __('common.general.join_us_to_manage_your_loans_efficiently') }}</p>
      </div>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-floating">
          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
            value="{{ old('name') }}" placeholder="{{ __('common.general.full_name') }}" required autofocus>
          <label for="name"><i class="fas fa-user me-2"></i>Full name</label>
        </div>

        <div class="form-floating">
          <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
            value="{{ old('email') }}" placeholder="{{ __('common.general.email_address') }}" required>
        ...
        <p class="form-text text-muted small mb-3">
          <i class="fas fa-info-circle me-1"></i>At least 8 characters
        </p>

        <div class="form-floating mb-3">
          <input type="password" class="form-control" id="password_confirmation" name="password_confirmation"
            placeholder="{{ __('common.auth.confirm_password') }}" required>
        ...
        <div class="form-check mb-3">
          ...
          <label class="form-check-label" for="terms">
            I agree to the <a href="#"
              class="text-primary text-decoration-none">{{ __('common.pagination.terms_of_service') }}</a> and <a
              href="#" class="text-primary text-decoration-none">{{ __('common.form.privacy_policy') }}</a>
          </label>
        </div>
      ...
      @if ($hasAnySocialLogin)
        <!-- Divider -->
        <div class="divider">
          <span>{{ __('common.general.or_sign_up_with') }}</span>
        </div>
