<?php
/**
 * Script to auto-translate auth.php from English to Khmer and Chinese
 * Uses Laravel's GoogleTranslateService
 *
 * Usage: php translate_auth.php
 */
...
try {
    echo "========================================\n";
    echo "  Translation Script - auth.php\n";
    echo "========================================\n\n";
    ...
    $khFile = __DIR__ . '/resources/lang/kh/auth.php';
    exportToPhpFile($khData, $khFile, 'Authentication Language Lines (Khmer)');
    ...
    $zhFile = __DIR__ . '/resources/lang/zh/auth.php';
    exportToPhpFile($zhData, $zhFile, 'Authentication Language Lines (Chinese)');
